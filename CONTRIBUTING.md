## Yomi contribution guidelines

+ If you want to **fix bugs** or **implement new features** that **already have an [issue card](https://github.com/YomiApp/Yomi/issues):** please assign this issue to you and/or comment about it.
...
+ In case you want to **add a new manga source,** refer to the [parsers repository](https://github.com/YomiApp/kotatsu-parsers).
